...
class App extends React.Component {
	...
	addRecord = () => {
		...
		var body = JSON.stringify({ name: this.state.name,age:this.state.age, location: this.state.location });
	...
	updateRecord = () => {
		...
		var body = JSON.stringify({ id: this.state.id, name: this.state.name,age:this.state.age, location: this.state.location });
					...
					<Row>
						<Form>
							...
							<FormGroup>
								...
								<FormControl type="text" name="age" value={this.state.age} onChange={this.handleChange} placeholder="Enter the Age"></FormControl>
							</FormGroup>
							<FormGroup>
